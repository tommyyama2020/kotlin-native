...
extern "C" OBJ_GETTER(
    Kotlin_ObjCExport_createContinuationArgumentImpl, KRef completionHolder, const TypeInfo** exceptionTypes);
...
extern "C" OBJ_GETTER(Kotlin_ObjCExport_createContinuationArgument, id completion, const TypeInfo** exceptionTypes) {
    ...
    KRef completionHolder =
        AllocInstanceWithAssociatedObject(theForeignObjCObjectTypeInfo, objc_retainBlock(completion), slot.slot());
