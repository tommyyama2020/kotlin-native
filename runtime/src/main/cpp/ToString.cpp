...
OBJ_GETTER(Kotlin_Int_toStringRadix, KInt value, KInt radix){RETURN_RESULT_OF(Kotlin_toStringRadix<KInt>, value, radix)}
...
OBJ_GETTER(Kotlin_Long_toStringRadix, KLong value, KInt radix){RETURN_RESULT_OF(Kotlin_toStringRadix<KLong>, value, radix)}
